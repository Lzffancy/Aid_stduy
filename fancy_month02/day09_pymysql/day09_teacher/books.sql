...
CREATE TABLE `图书` (
  ...
  CONSTRAINT `图书_ibfk_2` FOREIGN KEY (`press_id`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `index_test` VALUES (1,'Tom0'),(2,'Tom1'),(3,'Tom2'),(4,'Tom3'),(5,'Tom4'),(6,'Tom5'),(7,'Tom6'),(8,'Tom7'),(9,'Tom8'),(10,'Tom9');
...
CREATE TABLE `press_author` (
  ...
  KEY `author_id` (`author_id`),
  KEY `press_id` (`press_id`),
  CONSTRAINT `press_author_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `作家` (`id`),
  CONSTRAINT `press_author_ibfk_2` FOREIGN KEY (`press_id`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-07 10:21:59
