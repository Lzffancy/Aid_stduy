...
INSERT INTO `class` VALUES (1,'Lily',17,'f',97),(3,'Tom',16,'m',83),(4,'Joy',18,'m',92),(6,'Abby',18,'f',97),(7,'Emma',16,'f',81),(8,'Levi',17,'m',86),(9,'Sunny',16,'m',91),(10,'Eva',16,'f',71);
...
INSERT INTO `good_student` VALUES (1,'Lily',17,'f',97),(4,'Joy',18,'m',92),(6,'Abby',18,'f',97),(9,'Sunny',16,'m',91);
...
INSERT INTO `hobby` VALUES (1,'Joy','sing,dance',56800.00,NULL,'骨骼惊奇'),(2,'Abby','sing',14800.89,NULL,'天籁之音'),(3,'Barom','draw',26800.00,NULL,'当代达芬奇'),(4,'Jame','dance',8800.00,NULL,NULL),(5,'Emma','sing,draw',44800.00,NULL,NULL),(6,'Chen','sing',16800.00,NULL,NULL);
...
INSERT INTO `marathon` VALUES (1,'尼古拉斯赵四','1998-10-11','2021-01-01 10:10:08','02:19:48'),(2,'托尼帕克','2000-07-06','2020-12-27 19:01:08','02:38:55'),(3,'曹操','1999-05-10','2021-01-02 21:15:08','02:29:18'),(4,'斯蒂芬凯奇','1995-08-26','2021-01-04 10:39:50','02:58:40');
...
/*!50001 VIEW `good_stu` AS select `class`.`id` AS `id`,`class`.`name` AS `name`,`class`.`age` AS `age`,`class`.`score` AS `score` from `class` where (`class`.`score` >= 90) */;
...
-- Dump completed on 2021-01-07 10:19:06
